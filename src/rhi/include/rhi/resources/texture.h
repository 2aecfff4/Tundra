...
/// A set of flags representing different access patterns for textures.
///
/// This enumeration is used to specify the intended access patterns for textures.
...
enum class TextureAccessFlags : u16 {
    NONE = 0,
    TRANSFER_SOURCE = 1 << 0,
...
TNDR_ENUM_CLASS_FLAGS(TextureAccessFlags)
